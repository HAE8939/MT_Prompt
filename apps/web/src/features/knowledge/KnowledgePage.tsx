...
export function KnowledgePage() {
  ...
  return <main className="knowledge-page"><header className="page-header"><div><h1>模板与技能</h1><span className="count">本地知识库 · {counts.TEMPLATE} 个模板 · {counts.SKILL} 个 Skill · {counts.RULE} 条规则</span></div><button className="primary-button" onClick={() => setEditor("new")}><Plus size={14} />新建{labels[kind]}</button></header>
